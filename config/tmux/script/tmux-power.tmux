...
WSFormat="$StartFormat #{?#{==:#{pane_current_command},ssh},#[fg=$red]#I #W #[fg=$green] ,#[fg=$FG]#I #W }"
...
WSCFormat="$WSCFormat#{?#{==:#{pane_current_command},ssh},#[fg=$BG]#[bold] #I $HOST_NAME #[fg=$green] ,#[fg=$BG]#[bold] #I #W }"
...
sshStatus="#[fg=$red]#[bg=$BG]#[fg=$BG]#[bg=$red]#[bold] $HOST_NAME "
...
RS="#[fg=#aab2bf,bg=$BG] $date_icon $date_format#[fg=$BG,bg=$BG]$RS"
RS="#[fg=#aab2bf,bg=$BG] $time_icon $time_format#[fg=$BG]$RS"
